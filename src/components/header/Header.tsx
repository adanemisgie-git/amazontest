  ...
  return (
    <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50 ">
      <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4">
        ...
        {/* delivery */}
        <div className="px-2 border border-transparent flex hover:border-white cursor-pointer duration-300 items-center justify-center h-[70%] xl:inline-flex gap-1">
          <SlLocationPin />
